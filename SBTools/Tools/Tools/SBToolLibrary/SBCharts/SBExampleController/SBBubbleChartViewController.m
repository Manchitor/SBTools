...
@interface SBBubbleChartViewController ()<IChartAxisValueFormatter, ChartViewDelegate>
...
@implementation SBBubbleChartViewController
...
- (BubbleChartView *)bubbleChartView {
    if (!_bubbleChartView) {
        _bubbleChartView = [[BubbleChartView alloc] initWithFrame:CGRectMake(0, SB_NAV_HEIGHT, SB_SCREEN_WIDTH, SB_SCREEN_HEIGHT - SB_NAV_HEIGHT - SB_NAV_HEIGHT)];
