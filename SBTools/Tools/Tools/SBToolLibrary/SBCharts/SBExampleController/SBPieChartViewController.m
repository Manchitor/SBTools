...
@interface SBPieChartViewController ()
...
@implementation SBPieChartViewController
...
- (PieChartView *)pieChartView {
    if (!_pieChartView) {
        _pieChartView = [[PieChartView alloc] initWithFrame:CGRectMake(0, SB_NAV_HEIGHT, SB_SCREEN_WIDTH, SB_SCREEN_HEIGHT - SB_NAV_HEIGHT - SB_NAV_HEIGHT)];
    }
