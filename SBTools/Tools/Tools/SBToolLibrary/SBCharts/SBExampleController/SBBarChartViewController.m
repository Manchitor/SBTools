...
@interface SBBarChartViewController ()<IChartAxisValueFormatter, ChartViewDelegate>
...
- (BarChartView *)barChartView {
    if (!_barChartView) {
        _barChartView = [[BarChartView alloc] initWithFrame:CGRectMake(0, SB_NAV_HEIGHT, SB_SCREEN_WIDTH, SB_SCREEN_HEIGHT - SB_NAV_HEIGHT - SB_NAV_HEIGHT)];
